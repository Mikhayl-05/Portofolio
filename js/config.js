...
const PAMERAN = {
  ...
  templat: {
    ...
    paragraphs  : [
      ...
      `Disana.. ada <em>cewek</em> seumuran gw yang jadi sahabat dekat gw sejak masih kecil banget. Dia cantik dan keturunan Tionghoa (Chindo), ramah, dan keluarganya baik banget sama gw. Kita sering main, jajanan, dan jalan bareng ke Taman Bungkul atau ke Mall Tunjungan Plaza, ngobrol santai, atau sekadar nikmatin angin sore. Momen bareng dia bikin Surabaya punya warna lain—bukan sekadar nostalgia masa kecil, tapi juga kebersamaan dan <em><b><span id="easter-rasa" style="cursor:pointer;">rasa</span></b></em> yang tumbuh jadi bagian penting dari cerita gw.`,
