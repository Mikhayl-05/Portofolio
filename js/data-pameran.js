const PAMERAN = {
  ...
  komputer: {
    ...
    content: `
      ...
      <p>
        <em> "Belajar komputer bikin elu keliatan keren" </em>
      </p>
    `
  },
  ...
  media: {
    ...
    content: `
      ...
      <p>
        <em> "Seandainya gw direkrut kembali dan bisa mengulang momen-momen itu kembali.." </em>
      </p>
    `
  },
  ...
  templat: {
    ...
    content: `
      ...
      <p>
        Yang bikin Surabaya makin berkesan adalah interaksi kecil sehari-hari. 
        Dari sapaan ramah tetangga "Sini mas, mampir sek.", pedagang yang selalu senyum, sampai momen nongkrong di Taman Bungkul bareng temen atau orang spesial.
         Taman Bungkul sendiri jadi simbol kebersamaan buat gw—tempat di mana obrolan sederhana bisa berubah jadi kenangan yang dalam. 
         Di sana gw ngerasa Surabaya bukan cuma kota, tapi ruang aman buat ketawa, cerita, dan bersosial dengan orang-orang.
      </p>
      ...
      <p>
       Disana.. ada <em>cewek</em> seumuran gw yang jadi sahabat dekat gw sejak masih kecil banget. Dia cantik, ramah, dan keluarganya baik banget sama gw. Kita sering main, jajanan, dan jalan bareng ke Taman Bungkul atau ke Mall Tunjungan Plaza, ngobrol santai,
        atau sekadar nikmatin angin sore. Momen bareng dia bikin Surabaya punya warna lain—bukan sekadar nostalgia masa kecil,
         ...
         </b></em> yang tumbuh jadi bagian penting dari cerita gw.
      </p>
